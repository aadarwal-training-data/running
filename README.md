...
This repository pairs a short formal note in LaTeX with executable
...
1. Read the compiled [`tex/running.pdf`](tex/running.pdf) or its
   [`tex/main.tex`](tex/main.tex) source.
...
make paper       # compile build/main.pdf and refresh tex/running.pdf
```
...
Everything under `src/running` is educational reference code. It is deliberately
clear Python, not constant-time production cryptography. For real applications,
use a maintained protocol and library such as TLS 1.3, Noise, HPKE, or libsodium.
