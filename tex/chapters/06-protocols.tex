...
computer running Shor's algorithm would solve ECDLP. Hybrid deployments combine
classical authentication and X25519 with a standardized post-quantum mechanism
according to a reviewed protocol; ad hoc concatenation is not a protocol.
...
\begin{takeaway}
The chain is modular: ECDLP hardness supports scalar multiplication; X25519
packages scalar multiplication; a KDF turns its output into keys; authentication
