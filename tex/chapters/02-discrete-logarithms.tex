...
\draw[->,thick,runninggreen] (secret) --
  node[above,text=runninggreen] {forward: $O(n)$ group operations} (public);
\draw[->,thick,runningorange] (public) to[bend left=38]
  node[below,text=runningorange,align=center]
